<template>
    ...
    <v-card class="popup-del-com ">
      ...
      <p id="span-del-post"> ⚠️ Continuer effacera votre commentaire en attente  ⚠️ </p>
       ...
       <v-btn id="btn-notdelete-comfirm" @click="$emit('close-modale-double-save')" ><span >J'ai oublier</span></v-btn>
      <p class="comfirm-span-delete">si tel est votre choix ...</p>
      
    <v-btn  @click="$emit('close-modale-double-delete-confirm')"   id="btn-delete-comfirm"  ><span>Continuer</span></v-btn>
