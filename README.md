# TP7-OC-GROUPOMANIA-soutenance
  ...
  ## Démarrage du projet :
   ...
   ## Précision :
        ...
        ### Une collection Mondodb à été crée avec les employé(e)s de GROUPOMANIA, dans le dossier en votre possession 'employees groupomania',
